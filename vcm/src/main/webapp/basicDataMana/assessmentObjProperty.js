...
Ext.onReady(function() {
	...
	Ext.define('UNIT_CODEModel', {
				extend : 'Ext.data.Model',
				fields : ['UNIT_CODE','UNIT_NAME']
			});

	var UNIT_CODEStore = Ext.create('Ext.data.Store', {
				model : 'UNIT_CODEModel',
				proxy : {
					type : 'ajax',
					url : 'AssessmentObjPropertyAction!queryUNIT_CODE.action',
					reader : {
						root : 'queryUNIT_CODEList',
						type : 'json'
					}
				}
			});
	...
	Ext.define('TYPE_CODEModel', {
				extend : 'Ext.data.Model',
				fields : ['TYPE_CODE','TYPE_NAME']
			});

	var TYPE_CODEStore = Ext.create('Ext.data.Store', {
				model : 'TYPE_CODEModel',
				proxy : {
					type : 'ajax',
					url : 'AssessmentObjPropertyAction!queryTYPE_CODE.action',
					reader : {
						root : 'queryTYPE_CODEList',
						type : 'json'
					}
				}
			});
	...
	Ext.define('USAGE_CODEModel', {
				extend : 'Ext.data.Model',
				fields : ['UASAGE_CODE','UASAGE_NAME']
			});

	var USAGE_CODEStore = Ext.create('Ext.data.Store', {
				model : 'USAGE_CODEModel',
				proxy : {
					type : 'ajax',
					url : 'AssessmentObjPropertyAction!queryUSAGE_CODE.action',
					reader : {
						root : 'queryUSAGE_CODEList',
						type : 'json'
					}
				}
			});
	USAGE_CODEStore.load();	
	
	
	/** ***************影响程度*************** */

	Ext.define('EFFECT_DEGREE_CODEModel', {
				extend : 'Ext.data.Model',
				fields : ['EFFECT_DEGREE_CODE','EFFECT_DEGREE_NAME']
			});

	var EFFECT_DEGREE_CODEStore = Ext.create('Ext.data.Store', {
				model : 'EFFECT_DEGREE_CODEModel',
				proxy : {
					type : 'ajax',
					url : 'AssessmentObjPropertyAction!queryEFFECT_DEGREE.action',
					reader : {
						root : 'queryEFFECT_DEGREEList',
						type : 'json'
					}
				}
			});
	EFFECT_DEGREE_CODEStore.load();	
	
	/** ***************分析类型*************** */

	Ext.define('ANALYSE_TYPEModel', {
				extend : 'Ext.data.Model',
				fields : ['ANALYSE_TYPE','ANALYSE_TYPE_NAME']
			});

	var ANALYSE_TYPEStore = Ext.create('Ext.data.Store', {
				model : 'ANALYSE_TYPEModel',
				proxy : {
					type : 'ajax',
					url : 'AssessmentObjPropertyAction!queryANALYSE_TYPE.action',
					reader : {
						root : 'queryANALYSE_TYPEList',
						type : 'json'
					}
				}
			});
	ANALYSE_TYPEStore.load();	
	/** ***************分析项等级*************** */

	Ext.define('EVENT_LEVELModel', {
				extend : 'Ext.data.Model',
				fields : ['EVENT_LEVEL','EVENT_LEVEL_NAME']
			});

	var EVENT_LEVELStore = Ext.create('Ext.data.Store', {
				model : 'EVENT_LEVELModel',
				proxy : {
					type : 'ajax',
					url : 'AssessmentObjPropertyAction!queryEVENT_LEVEL.action',
					reader : {
						root : 'queryEVENT_LEVELList',
						type : 'json'
					}
				}
			});
	EVENT_LEVELStore.load();	
		...
		items : [
{
	...
	name : 'AOP_ATTR_ID'},

		         {
					...
					xtype : 'combo',
					queryMode : 'local',
					store : USAGE_CODEStore,
					displayField : 'UASAGE_NAME',
					valueField : 'UASAGE_CODE',
					value : '03'
					,
				}, {
					x : 260,
					...
					xtype : 'combo',
					queryMode : 'local',
					store : EFFECT_DEGREE_CODEStore,
					displayField : 'EFFECT_DEGREE_NAME',
					valueField : 'EFFECT_DEGREE_CODE',
					value : '02'
					,
				},
...

				{
					...
					xtype : 'combo',
					queryMode : 'local',
					store : ANALYSE_TYPEStore,
					displayField : 'ANALYSE_TYPE_NAME',
					valueField : 'ANALYSE_TYPE',
					value : '02'
					,
				}, {
					x : 510,
