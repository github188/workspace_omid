package com.nari.common.dao.hibernate4;
...
import com.nari.common.dao.util.ConditionQuery;
import com.nari.common.dao.util.OrderBy;
import com.nari.common.pagination.PageUtil;
import com.nari.common.util.Assert;
...
public abstract class BaseHibernateDao<M extends java.io.Serializable, PK extends java.io.Serializable> implements IBaseDao<M, PK> {
    ...
    protected long getIdResult(String hql, Object... paramlist) {
        long result = -1;
        List<?> list = list_all(hql, paramlist);
    ...
    /**
     * 修改方法名称避免 ambiguous type for method 问题或警告错误
     */
    protected <T> List<T> list_all(final String sql, final Object... paramlist) {
    ...
    public List<M> findBy(String hql,final Object... paramlist){
		Query query = getSession().createQuery(hql);
		setParameters(query, paramlist);
